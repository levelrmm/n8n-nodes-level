...
export const alertsFields: INodeProperties[] = [
	...
	{ displayName: 'List Options', name: 'alertsListOptions', type: 'collection', placeholder: 'Add Option', default: {}, displayOptions: { show: { resource: ['alerts'], operation: ['list'] } }, options: [
